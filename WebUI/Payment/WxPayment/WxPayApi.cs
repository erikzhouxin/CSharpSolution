    ...
    public class WxPayApi
    {
        ...
        */
        public static WxPayData Micropay(WxPayData inputObj, int timeOut = 10)
        {
            ...
            string response = WxPayHttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
        ...
        */
        public static WxPayData OrderQuery(WxPayData inputObj, int timeOut = 6)
        {
            ...
            string response = WxPayHttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口提交数据
        ...
        */
        public static WxPayData Reverse(WxPayData inputObj, int timeOut = 6)
        {
            ...
            string response = WxPayHttpService.Post(xml, url, true, timeOut);
        ...
        */
        public static WxPayData Refund(WxPayData inputObj, int timeOut = 6)
        {
            ...
            string response = WxPayHttpService.Post(xml, url, true, timeOut);//调用HTTP通信接口提交数据到API
	    ...
	    */
        ...
        /// 下载对账单
        /// </summary>
        /// <param name="inputObj">inputObj 提交给下载对账单API的参数</param>
	    ...
	    */
        public static WxPayData ShortUrl(WxPayData inputObj, int timeOut = 6)
	    {
            ...
            string response = WxPayHttpService.Post(xml, url, false, timeOut);
	    ...
	    */
        private static void ReportCostTime(string interface_url, int timeCost, WxPayData inputObj)
	    {
		    ...
		    //如果仅失败上报
		    if(WxPayConfig.ReportLevel == 1 && inputObj.IsSet("return_code") && inputObj.GetValue("return_code").ToString() == "SUCCESS" &&
            ...
            {
                WxPayLog.Error(typeof(WxPayApi).ToString(), ex.Message);
            }
	    }
