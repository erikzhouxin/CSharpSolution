<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="refund.aspx.cs" Inherits="EZOper.CSharpSolution.WebUI.WebForm.Alipayment.refund" %>
            ...
            <div id="body" style="clear: left">
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <span>支付宝交易号与商户网站订单号不能同时为空</span>
                    </dd>
                    <dt>商户退款请求单号：</dt>
                    <dd>
                        <span class="null-star">*</span>
                    ...
                    <dd>
                        <span class="new-btn-login-sp">
                            <asp:Button ID="BtnAlipay" name="BtnAlipay" class="new-btn-login" Text="确 认" Style="text-align: center;"
                                runat="server" OnClick="BtnAlipay_Click" /></span></dd>
                </dl>
            </div>
            <div id="foot">
                <ul class="foot-ul">
