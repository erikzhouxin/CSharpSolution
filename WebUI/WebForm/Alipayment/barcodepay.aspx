<%@ page language="C#" autoeventwireup="true" codebehind="barcodepay.aspx.cs" inherits="EZOper.CSharpSolution.WebUI.WebForm.Alipayment.barcodepay" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        * { margin: 0; padding: 0; }
        ...
        .new-btn-login { background-position: 0 -198px; width: 82px; color: #FFFFFF; font-weight: bold; line-height: 28px; padding: 0 10px 3px; }
                        ...
                        <font class="note-help">
                            <span class="new-btn-login-sp">
                                <asp:Button ID="BtnAlipay0" name="BtnAlipay" class="new-btn-login" Text="提交" Style="text-align: center; height: 20px;"
                                    runat="server" OnClick="Alipay_RSA_Submit" /></span> </font></dd>
                </dl>
            </div>
            <div id="foot">
                <ul class="foot-ul">
                    <li><font class="note-help">如果您点击“提交”按钮，即表示您同意该次的执行操作。 </font></li>
