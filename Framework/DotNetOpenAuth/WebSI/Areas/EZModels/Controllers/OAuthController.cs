...
namespace EZOper.TechTester.OAuth2WebSI.Areas.EZModels.Controllers
{
    public class OAuthController : Controller
    {
        ...
        {
            return this.authorizationServer.HandleTokenRequest(this.Request).AsActionResult();//.AsActionResultMvc5();
        }
        ...
        public ActionResult Authorise()
        {
            ...
            if (((OAuth2AuthorizationServer)this.authorizationServer.AuthorizationServerServices).CanBeAutoApproved(pendingRequest))
            {
                ...
                return this.authorizationServer.Channel.PrepareResponse(approval).AsActionResult();//.AsActionResultMvc5();
            }
        ...
        public ActionResult AuthoriseResponse(bool isApproved)
        {
            ...
            return this.authorizationServer.Channel.PrepareResponse(response).AsActionResult();//.AsActionResultMvc5();
        }
    }
}