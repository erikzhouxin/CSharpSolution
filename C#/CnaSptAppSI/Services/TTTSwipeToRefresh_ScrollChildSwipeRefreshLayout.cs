...
{
    public class TTTSwipeToRefresh_ScrollChildSwipeRefreshLayout : SwipeRefreshLayout
    {
        public TTTSwipeToRefresh_ScrollChildSwipeRefreshLayout(Context context) : base(context)
        {
        }

        public TTTSwipeToRefresh_ScrollChildSwipeRefreshLayout(Context context, IAttributeSet attrs) : base(context, attrs)
        {
        }
