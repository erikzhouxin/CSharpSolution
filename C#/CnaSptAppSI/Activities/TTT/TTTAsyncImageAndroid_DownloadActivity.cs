...
namespace EZOper.TechTester.CnaSptAppSI
{
    ...
    [Activity(Label = "AsyncImageAndroid", ConfigurationChanges = Android.Content.PM.ConfigChanges.Orientation)]
    public class TTTAsyncImageAndroid_DownloadActivity : Activity
    {
        int count = 1;
        WebClient webClient;
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            SetContentView(Resource.Layout.TTTAsyncImageAndroid_Download);
        ...
        async void downloadAsync(object sender, System.EventArgs ea)
        {
            ...
            var url = new Uri("http://www.erikzhouxin.com/Content/Images/EZLogo/EZX256.ico");
            byte[] bytes = null;
