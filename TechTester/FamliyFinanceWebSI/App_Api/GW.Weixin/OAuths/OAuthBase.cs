...
namespace GW.Weixin.OAuths
{
    ...
    public abstract partial class OAuthBase
    {
        ...
        protected const string OAuthAuthorizeKey = "authorize";
        ...
        {
            string authorizeUrl = OAuthConfig.GetConfigAPI(OAuthName, this.App.AppName, OAuthAuthorizeKey);
