...
namespace EZOper.TechTester.DotNetOpenAuth2WebSI.Areas.ClientMan.Controllers
{
    public class ClientController : ApiController
    {
        ...
        public HttpResponseMessage GetApis()
        {
            ...
            using (var resourceResponse = httpClient.GetAsync(ContextConfig.OpenApiAddress))
            {
