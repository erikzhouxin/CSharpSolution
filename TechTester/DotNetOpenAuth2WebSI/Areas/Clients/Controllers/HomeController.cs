...
namespace EZOper.TechTester.DotNetOpenAuth2WebSI.Areas.Clients.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            TokenEndpoint = new Uri(ContextConfig.TokenEndpoint),
            AuthorizationEndpoint = new Uri(ContextConfig.AuthorizationEndpoint),
        ...
        public ActionResult Pure(string code, string state)
        {
                ...
                var httpContent = new FormUrlEncodedContent(new Dictionary<string, string>()
            {
                ...
                var response = httpClient.PostAsync(ContextConfig.TokenEndpoint, httpContent).Result;
        ...
        public ActionResult PureInvoke()
        {
            ...
            if (Authorization == null)
            {
                ...
                string url = ContextConfig.AuthorizationEndpoint + "?" + string.Format("client_id={0}&redirect_uri={1}&response_type={2}&state={3}",//&scope=
        ...
        {
            string xsrfKey = this.GetNonCryptoRandomDataAsBase64(16);//生成随机数
            string url = ContextConfig.AuthorizationEndpoint + "?" +
