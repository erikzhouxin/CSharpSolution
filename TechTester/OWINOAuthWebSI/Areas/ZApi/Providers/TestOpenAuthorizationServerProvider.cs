...
namespace EZOper.TechTester.OWINOAuthWebSI.Areas.ZApi.Controllers
{
    ...
    /// 授权码模式+简单模式
    /// </summary>
    public class TestOpenAuthorizationServerProvider : OAuthAuthorizationServerProvider
    {
        /// <summary>
        /// 验证 client 信息
        /// </summary>
    ...
    /// 客户端模式
    /// </summary>
    public class TestClientOpenAuthorizationServerProvider : OAuthAuthorizationServerProvider
    {
        /// <summary>
        /// 验证 client 信息
        /// </summary>
    ...
    /// 密码模式
    /// </summary>
    public class TestPasswordOpenAuthorizationServerProvider : OAuthAuthorizationServerProvider
    {
        /// <summary>
        /// 验证 client 信息
        /// </summary>
