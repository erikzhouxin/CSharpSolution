...
namespace EZOper.NetSiteUtilities.Alipayment
{
    ...
    public class AlipayNotify
    {
        ...
        public AlipayNotify(string charset, string sign_type, string pid, string mapiUrl, string alipay_public_key)
        {
            //初始化基础配置信息
            _charset = charset;
        ...
        public AlipayNotify() : this(AlipayConfig.charset, AlipayConfig.sign_type, AlipayConfig.pid, AlipayConfig.mapiUrl, AlipayConfig.alipay_public_key)
        {
        }
