...
namespace EZOper.NetSiteUtilities.Alipayment
{
    ...
    public class AlipayMonitorImpl : IAlipayMonitor
    {
        ...
        public AlipayMonitorImpl(string monitorUrl, string appId, string merchant_private_key, string format, string version, string sign_type, string alipay_public_key, string charset)
        {
            client = new DefaultAopClient(monitorUrl, appId, merchant_private_key, format, version, sign_type, alipay_public_key, charset);
        }
