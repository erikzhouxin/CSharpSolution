...
namespace EZOper.NetSiteUtilities.Wepayment
{
    ...
    public class WxPayLog
    {
        ...
        */
        ...
        public static void ErrorThrow(string className, string content)
        {
            WriteLog("ERRORTHROW", className, content);
            throw new WxPayException(content);
        }
